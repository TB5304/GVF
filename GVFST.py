...
Y0 = st.sidebar.number_input('Enter depth of flow Y0 (m)',format="%.5f", min_value=0.0, max_value=10.0, value=1.0, step=0.1)
B = st.sidebar.number_input('Enter bottom width B (m)',format="%.5f", min_value=0.0, max_value=10.0, value=1.0, step=0.1)
n = st.sidebar.number_input('Enter Manning roughness coefficient n',format="%.5f", min_value=0.01, max_value=0.1, value=0.03, step=0.01)
S0 = st.sidebar.number_input('Enter channel bed slope S0', format="%.5f", min_value=0.0, max_value=0.1, value=0.01, step=0.001) 
