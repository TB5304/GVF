...
Y0 = st.sidebar.number_input('Enter depth of flow Y0 (m)', min_value=0.0, max_value=10.0, value=0.0, step=0.1)
Q = st.sidebar.number_input('Enter Q', min_value=0.0, max_value=10.0, value=0.0, step=0.1)
